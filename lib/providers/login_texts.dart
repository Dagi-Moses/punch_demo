...
class LoginTexts extends ChangeNotifier {
  ...
  static const String _defaultWelcomeBack = 'Welcome!';
  static const String _defaultWelcomeBackDescription =
      "Welcome  to Punch Anniversary. We're always here, waiting for you!";
  static const String _defaultLogin = 'Login';
  static const String _defaultLoginFormTitle = 'Login to Punch ';
